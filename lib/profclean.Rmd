...
```{r}
data.lib=~"~/Documents/Columbia /2017 spring/ADS/proj 4/nameset"
...
for(i in 1:length(data.files)){
  ...
  filepath <- file.path("~/Documents/Columbia /2017 spring/ADS/proj 4/nameset",paste(data.files[i],sep=""))
  dat=as.list(readLines(filepath))
  data_list[[i]]=lapply(dat, f.line.proc, nam.query=query.list[i])
}

save(data_list,file="profclean.RData")
```