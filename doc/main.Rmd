...
cluster_temp.list <- llply(simmatrix.list,singlecluster,theta=6)
...
```{r}
acc.c.6 <- accuracy.list.combined
acc.s.6 <- accuracy.list.single
save(acc.c.6,file="../output/temp_acc/acc_c_6.RData")
save(acc.s.6,file="../output/temp_acc/acc_s_6.RData")
f1.c.6 <- f1.list.combined
f1.s.6 <- f1.list.single
save(f1.c.6,file="../output/temp_f1_c/f1_c_6.RData")
save(f1.s.6,file="../output/temp_f1_s/f1_s_6.RData")
