...
ggplot()+
  geom_point(mapping=aes(x=index,y=f1.list.combined),color="blue",data=f1.combined)+
  geom_line(mapping=aes(x=index,y=f1.list.combined),data=f1,color="blue")+
  geom_point(mapping=aes(x=index,y=f1.list.single),data=f1.single,color="red")+
  geom_line(mapping=aes(x=index,y=f1.list.single),color="red")
